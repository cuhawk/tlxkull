---
source: detectify
source_url: https://labs.detectify.com/how-to/hack-apis-in-2021/
title: "How to Hack APIs in 2021 - Labs Detectify"
author: "Detectify"
published: 2021-08-10T10:00:29+00:00
description: "Detectify Crowdsource is not your average bug bounty platform. It’s an invite-only community of the best ethical hackers who are passionate about securing modern technologies ..."
---

[Home](https://labs.detectify.com/)/ [How to](https://labs.detectify.com/category/how-to/)/ [How to Hack APIs in 2021](https://labs.detectify.com/how-to/hack-apis-in-2021/)

[How to](https://labs.detectify.com/category/how-to/ "How to")

# How to Hack APIs in 2021

**Hakluke and Farah Hawa** Aug 10, 2021

[hakluke](https://labs.detectify.com/tag/hakluke/ "hakluke")

[Twitter](https://twitter.com/intent/tweet?url=https://labs.detectify.com/how-to/hack-apis-in-2021/ "Share on Twitter") [LinkedIn](https://www.linkedin.com/sharing/share-offsite/?url=https://labs.detectify.com/how-to/hack-apis-in-2021/ "Share on LinkedIn")

![How to Hack APIs in 2021](https://labs.detectify.com/_next/image/?url=https%3A%2F%2Flabsadmin.detectify.com%2Fapp%2Fuploads%2F2021%2F08%2FHack-APIs.png&w=3840&q=75)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/same-server-768x181-1.png)
...
_[Detectify blog: the fuzzing engine exploring public-facing APIs coverage](https://blog.detectify.com/2021/08/03/detectify-fuzzing-public-facing-apis/)_

![](https://labsadmin.detectify.com/app/uploads/2021/08/API.png)
...
All this to say – there are APIs everywhere now, so we should know how to hack and secure them. If you’re still reading – your fingers are probably hovering over ctrl+w. Your brain is thinking “this article title promised to teach me to hack, not what a SPA is. I am an intellectual individual and the author’s attempts at humour are futile, life is short and I am wasting my time reading this stupi….” HOLD IT! We’re getting there. I promise. Cool your jets. [G _oooooo_ sfraba](https://www.youtube.com/watch?v=rWIcubkPaxo).
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/postman-API-calls-Detectify-Labs.png)

After importing the collection, you will see the API calls loaded in Postman like so:

![](https://labsadmin.detectify.com/app/uploads/2021/08/unnamed-3.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/parameters-of-API-call-requests.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/how-to-modify-in-postman.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/response-view-in-postman-1536x642-1.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/GET-in-postman-169x300-1.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/get-postman-2-1536x430-1.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/authorization-of-values-1.png)

![](https://labsadmin.detectify.com/app/uploads/2021/08/authorization-of-values-crop.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/authorization-step-1.png)

2. Go to the **Authorization** tab, select the type of auth and add its value. ![](https://labsadmin.detectify.com/app/uploads/2021/08/authorization-step-2.png)
3. Lastly, go to an individual API request and select the **Inherit auth from parent** option

![](https://labsadmin.detectify.com/app/uploads/2021/08/authorization-step-3.png)
...
![](https://labsadmin.detectify.com/app/uploads/2021/08/settings-300x144-1.png)
2. Go to the **Proxy** tab and do this:
   ...
   - Set the **Proxy Server IP address** & **port** to match your Burp Suite proxy settings. The default values are 127.0.0.1 and 8080.
     ...
     ![](https://labsadmin.detectify.com/app/uploads/2021/08/final-setting-.png)
3. To proxy HTTPS requests without any errors, you can switch off **SSL certificate validation** under the **General** tab.

![](https://labsadmin.detectify.com/app/uploads/2021/08/toggle-SSL-certs-300x212-1.png)


[_Go fuzz yourself – how to find more vulns in APIs through fuzzing whitepaper._](https://detectify.com/resources/ebooks-whitepapers/whitepaper-how-to-find-more-vulnerabilities-in-apis-through-fuzzing)
...
Ensure that the XML parser being utilised is set up to _not_ parse XML entities.
