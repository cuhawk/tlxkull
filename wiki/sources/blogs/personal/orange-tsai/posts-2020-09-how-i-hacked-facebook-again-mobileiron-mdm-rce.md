---
source: orange-tsai
source_url: https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/
title: "How I Hacked Facebook Again! Unauthenticated RCE on MobileIron MDM | Orange Tsai"
author: "Orange Tsai"
published: 2020-09-11T16:00:00.000Z
description: "📌 [ 繁體中文 | English ] Hi, it’s a long time since my last article. This new post is about my research this March, which talks about how I found vulnerabilities on a leading Mobile Device Management"
---
...
# [What is MDM?](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#What-is-MDM "What is MDM?") What is MDM?
...
# [Our target](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Our-target "Our target") Our target
...
# [Where to Start](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Where-to-Start "Where to Start") Where to Start
...
_P.S. We have informed MobileIron and the sensitive files has been removed now._

# [Finding Vulnerabilities](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Finding-Vulnerabilities "Finding Vulnerabilities") Finding Vulnerabilities
...
|     |     |
| --- | --- |
| ```<br>1<br>2<br>``` | ```<br>RewriteRule ^/mifs/services/(.*)$ https://%{SERVER_NAME}:8443/mifs/services/$1 [R=307,L]<br>RewriteRule ^/mifs/services [F]<br>``` |
...
# [Exploiting Vulnerabilities](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Exploiting-Vulnerabilities "Exploiting Vulnerabilities") Exploiting Vulnerabilities
...
# [Attacking Facebook](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Attacking-Facebook "Attacking Facebook") Attacking Facebook
...
|     |     |
| --- | --- |
| ```<br>1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>``` | ```<br>$ diff 1_5_6/MethodClosure.java 3_0_4/MethodClosure.java<br>>     private Object readResolve() {<br>>         if (ALLOW_RESOLVE) {<br>>             return this;<br>>         }<br>>         throw new UnsupportedOperationException();<br>>     }<br>``` |
...
MobileIron MDM unauthenticated RCE (with Facebook as case study) - YouTube

Tap to unmute

[MobileIron MDM unauthenticated RCE (with Facebook as case study)](https://www.youtube.com/watch?v=hGTLIIOb14A) [Orange Tsai](https://www.youtube.com/channel/UCnweRFxfA-xpTbkb83yfBog)

Orange Tsai3.75K subscribers

[Watch on](https://www.youtube.com/watch?v=hGTLIIOb14A)

# [Vulnerability Report and Patch](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Vulnerability-Report-and-Patch "Vulnerability Report and Patch") Vulnerability Report and Patch
...
# [Conclusion](https://blog.orange.tw/posts/2020-09-how-i-hacked-facebook-again-mobileiron-mdm-rce/\#Conclusion "Conclusion") Conclusion
