---
source: slonser
source_url: https://blog.slonser.info/posts/dompurify-node-type-confusion
title: "DOM Purify - untrusted Node bypass - Slonser Notes"
published: 2024-03-19T00:00:00+03:00
...
Introduction In this article, I aim t"
---
...
is a function that traverses the DOM tree objects, used for sanitizing elements. As a matter of fact, the following filters are passed to it: `NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_COMMENT | NodeFilter.SHOW_TEXT`

, but in order for the iterator to return Process instructions, the filter `NodeFilter.SHOW_PROCESSING_INSTRUCTION`
...
No. If you look closely, you will notice that in XML, the closing delimiter will be `?>`

, whereas the HTML parser in the browser will search for `>`
...
While the tag `<_slonser-foo-bar>`

will be valid in XML, it won’t be recognized as a tag in HTML.
