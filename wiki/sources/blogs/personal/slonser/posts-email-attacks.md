---
source: slonser
source_url: https://blog.slonser.info/posts/email-attacks
title: "Old new email attacks - Slonser Notes"
published: 2024-05-23T15:00:00+03:00
...
Introduction This article will be ded"
---
...
The email standard allows inserting a domain within square brackets `[]`

, where a broader range of characters is permitted (though still limited).
...
Gmail allows inserting `<something>`

before the actual email address, which leads to incorrect parsing of the address by many email providers, including Outlook.
