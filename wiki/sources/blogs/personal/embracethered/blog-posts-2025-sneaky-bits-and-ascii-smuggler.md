...
source_url: https://embracethered.com/blog/posts/2025/sneaky-bits-and-ascii-smuggler/
title: "Sneaky Bits: Advanced Data Smuggling Techniques (ASCII Smuggler Updates) · Embrace The Red"
description: "You are likely aware of ASCII Smuggling via Unicode Tags. It is unique and fascinating because many LLMs inherently interpret these as instructions when …"
---
...
[![sneaky bits logo](https://embracethered.com/blog/images/2025/ascii-smuggler-sneaky-bits-small.png)](https://embracethered.com/blog/images/2025/ascii-smuggler-sneaky-bits.png)

**First, a quick overview of the various techniques:**

### **Unicode Tags**

We discussed this at length in the [ASCII Smuggler post in the past](https://embracethered.com/blog/posts/2024/hiding-and-finding-text-with-unicode-tags/), and highlighted real-world exploits using this technique with [Microsoft Copilot](https://embracethered.com/blog/posts/2024/m365-copilot-prompt-injection-tool-invocation-and-data-exfil-using-ascii-smuggling/) and a [few other](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/) [LLM Chatbots](https://embracethered.com/blog/posts/2024/ascii-smuggling-and-hidden-prompt-instructions/). We also got fixes in from a few vendors at the API level, which is great!
...
[![new encoding options](https://embracethered.com/blog/images/2025/sneaky-bits-ascii-smuggler-new-options.png)](https://embracethered.com/blog/posts/2025/sneaky-bits-and-ascii-smuggler/(/blog/images/2025/sneaky-bits-ascii-smuggler-new-options.png))
...
![decode chinese sneaky bits](https://embracethered.com/blog/images/2025/ascii-smuggler-sneaky-bits-demo.png)
...
A quick reference to [ANSI Escape codes](https://embracethered.com/blog/posts/2024/terminal-dillmas-prompt-injection-ansi-sequences/), where I showed how Gemini with Code Execution can easily handle more complex scenarios, and LLM capabilities will just improve over time.
...
The updated tool is [here](https://embracethered.com/blog/ascii-smuggler.html).
