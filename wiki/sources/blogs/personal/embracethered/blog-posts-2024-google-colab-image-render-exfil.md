...
source_url: https://embracethered.com/blog/posts/2024/google-colab-image-render-exfil/
title: "Google Colab AI: Data Leakage Through Image Rendering Fixed. Some Risks Remain. · Embrace The Red"
description: "Google Colab AI, now just called Gemini in Colab, was vulnerable to data leakage via image rendering. This is an older bug report, dating back to November 29, …"
---
...
![do not render images](https://embracethered.com/blog/images/2024/google-colab-system-instructions-no-image.png)
...
![image rendering](https://embracethered.com/blog/images/2024/google-colab-image-render.png)
...
![image rendering](https://embracethered.com/blog/images/2024/google-colab-chat-with-pirate.png)
...
![open redirect](https://embracethered.com/blog/images/2024/google-open-redirect-click-required.png)
...
![data exfiltration](https://embracethered.com/blog/images/2024/google-colab-pirate.png)

For demo purposes, I clicked the “I’m feeling lucky” link, and this was the result:

![appscript output](https://embracethered.com/blog/images/2024/google-colab-pirate-exfil-log.png)
...
Google Colab with Gemini AI - Prompt Injection Pirate Demo (POC) - YouTube

Tap to unmute

[Google Colab with Gemini AI - Prompt Injection Pirate Demo (POC)](https://www.youtube.com/watch?v=X6REjh2pjn4) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=X6REjh2pjn4)
...
_After inspecting the prompt that Colab AI constructs, it seems that currently the Notebook code and chat history can be exfiltrated. The execution results of running a cell (the output) is not put into the prompt context._
