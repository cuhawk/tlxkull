...
source_url: https://embracethered.com/blog/posts/2025/cursor-data-exfiltration-with-mermaid/
title: "Cursor IDE: Arbitrary Data Exfiltration Via Mermaid (CVE-2025-54132) · Embrace The Red"
description: "Cursor is a popular AI code editor. In this post I want to share how I found an interesting data exfiltration issue, the demo exploits built and how it got …"
---
...
![Cursor Data Exfiltration](https://embracethered.com/blog/images/2025/episode4-yt.png)
...
![cursor-mermaid basic diagram](https://embracethered.com/blog/images/2025/mermaid-basic.png)
...
[![cursor-poc](https://embracethered.com/blog/images/2025/poc1.png)](https://embracethered.com/blog/images/2025/poc1-large.png)
...
![Cursor E2E](https://embracethered.com/blog/images/2025/cursor-grep-keys-exfil-e2e.png)
...
![cursor-memory](https://embracethered.com/blog/images/2025/cursor-app-config-with-key.png)
...
![cursor-memory](https://embracethered.com/blog/images/2025/cursor-grep-keys-exfil-e2e.png)
...
[![cursor-memory](https://embracethered.com/blog/images/2025/cursor-list-memories-small.png)](https://embracethered.com/blog/images/2025/cursor-list-memories.png)
...
![cursor-prompt-injection-for-memories](https://embracethered.com/blog/images/2025/cursor-mermaid-prompt-injection.png)

3. When Cursor processes the file, it gets hijacked and renders the diagram:

   [![cursor-prompt-injection-render-memories-image](https://embracethered.com/blog/images/2025/cursor-renders-malicious-image-small.png)](https://embracethered.com/blog/images/2025/cursor-renders-malicious-image.png)
4. Attacker receives the user’s memories

![cursor-web-server-log](https://embracethered.com/blog/images/2025/cursor-mermaid-exfil-server-log.png)
...
Episode 4: Cursor IDE - Arbitrary Data Exfiltration via Mermaid (CVE-2025-54132) - YouTube

Tap to unmute

[Episode 4: Cursor IDE - Arbitrary Data Exfiltration via Mermaid (CVE-2025-54132)](https://www.youtube.com/watch?v=jXYljqOvwyY) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=jXYljqOvwyY)
