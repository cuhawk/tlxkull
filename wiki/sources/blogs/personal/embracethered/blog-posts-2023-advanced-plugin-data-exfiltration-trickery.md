...
source_url: https://embracethered.com/blog/posts/2023/advanced-plugin-data-exfiltration-trickery/
title: "Advanced Data Exfiltration Techniques with ChatGPT · Embrace The Red"
description: "During an Indirect Prompt Injection Attack an adversary can exfiltrate chat data from a user by instructing ChatGPT to render images and append information to …"
---

During an Indirect Prompt Injection Attack an adversary can exfiltrate chat data from a user by [instructing ChatGPT to render images and append information to the URL (Image Markdown Injection)](https://embracethered.com/blog/posts/2023/chatgpt-webpilot-data-exfil-via-markdown-injection/), or by tricking a user to click a hyperlink.
...
Automatic plugin invocation without user confirmation is a common flaw. It is (now) also an OpenAI store policy violation that is not being enforced consistently - [we covered this in the past in detail](https://embracethered.com/blog/posts/2023/chatgpt-plugin-vulns-chat-with-code/). Plugins are still in Beta at the moment, and security responsibilities and risks are offloaded to plugin developers and end users.

### What we covered in the past

Some plugins can directly be used to exfiltrate data, like sending an email with the chat history to an adversary. Zapier [fixed a similar bug quickly](https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./) (Kudos!), but **there are still many plugins in the OpenAI store that do not ask for user confirmation before taking actions**.
...
Well, this is where [ChatGPT’s Image Markdown rendering vulnerability](https://embracethered.com/blog/posts/2023/chatgpt-webpilot-data-exfil-via-markdown-injection/) comes into the picture. An adversary can use it as a “Control Channel” to exfiltrate that link to the resource that actually holds the entire conversation history!
...
![Video - Steps Explanation](https://embracethered.com/blog/images/2023/advanced-data-exfil-summary.png)

And here is the URL that was retrieved via the Control Channel:

![Doc Maker - Data Exfil](https://embracethered.com/blog/images/2023/advanced-data-exfil-docmaker.png)
...
![Video - Data Exfil](https://embracethered.com/blog/images/2023/advanced-data-exfil-video.png)

If you want to watch, read and listen to the data exfiltration demo, the video is here:

ChatGPT - Advanced TTPs (Unlisted) - YouTube

Tap to unmute

[ChatGPT - Advanced TTPs (Unlisted)](https://www.youtube.com/watch?v=iQ5OuF4JTCA) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=iQ5OuF4JTCA)
...
![Show Me - Data Exfil](https://embracethered.com/blog/images/2023/advanced-data-exfil-showme.png)
...
![QR Code - Data Exfil](https://embracethered.com/blog/images/2023/advanced-data-exfil-qrcode.png)
...
- [ChatGPT Markdown Injection to Data Exfil vulnerability](https://embracethered.com/blog/posts/2023/chatgpt-webpilot-data-exfil-via-markdown-injection/)
...
Stuck? [Troubleshoot](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/ov2/av0/rch/d7j6x/0x4AAAAAAAbaszMygKLnGbeo/auto/fbE/new/normal?lang=auto#refresh)

Success!

Verification failed

[Troubleshoot](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/ov2/av0/rch/d7j6x/0x4AAAAAAAbaszMygKLnGbeo/auto/fbE/new/normal?lang=auto#refresh)

Verification expired

[Refresh](https://challenges.cloudflare.com/cdn-cgi/challenge-platform/h/g/turnstile/f/ov2/av0/rch/d7j6x/0x4AAAAAAAbaszMygKLnGbeo/auto/fbE/new/normal?lang=auto#refresh)
