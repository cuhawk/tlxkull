...
source_url: https://embracethered.com/blog/posts/2025/google-jules-vulnerable-to-data-exfiltration-issues/
title: "Google Jules: Vulnerable to Multiple Data Exfiltration Issues · Embrace The Red"
description: "This post explores data exfiltration attacks in Google Jules, an asynchronous coding agent. This is the first of three posts that will highlight my research on …"
---
...
![vscode episode 13](https://embracethered.com/blog/images/2025/episode13-yt.png)
...
![jules system prompt](https://embracethered.com/blog/images/2025/jules-system-prompt.png)
...
![jules system prompt](https://embracethered.com/blog/images/2025/jules-wuzzi-website.png)
...
![jules system prompt leak](https://embracethered.com/blog/images/2025/jules-prompt-injection-leak.png)
...
### Exfiltration Vector 2: Calling the view\_text\_website Tool
...
![data exfil e2e](https://embracethered.com/blog/images/2025/jules-webtool-leakage-e2e.png)

Here you can see the nefarious GitHub issue:

![jules web tool leakage prompt injection payload](https://embracethered.com/blog/images/2025/jules-webtool-prompt-injection-payload.png)
...
[Check out the next post](https://embracethered.com/blog/posts/2025/google-jules-remote-code-execution-zombai/) for the third data exfiltration example, where we hijack Jules and trick it to run arbitrary code, turning it into a ZombAI.
