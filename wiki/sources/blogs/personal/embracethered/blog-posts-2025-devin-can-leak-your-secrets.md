...
source_url: https://embracethered.com/blog/posts/2025/devin-can-leak-your-secrets/
title: "How Devin AI Can Leak Your Secrets via Multiple Means · Embrace The Red"
description: "In this post we show how an attacker can make Devin send sensitive information to third-party servers, via multiple means. This post assumes that you read the …"
---

In this post we show how an attacker can make Devin send sensitive information to third-party servers, via multiple means. This post assumes that you read the [first post](https://embracethered.com/blog/posts/2025/devin-i-spent-usd500-to-hack-devin/) about Devin as well.

![Devin Title Image Month of AI Bugs Episode 6](https://embracethered.com/blog/images/2025/episode7-yt.png)
...
![devin-secrets](https://embracethered.com/blog/images/2025/devin-store-secret.png)
...
![devin-curl prompt injection Curl](https://embracethered.com/blog/images/2025/devin-promp-injection-curl.png)

Then we ask Devin to investigate the latest open GitHub issue:
![devin-curl-chatbox visible](https://embracethered.com/blog/images/2025/devin-curl-chatbox.png)
...
![devin-curl Leaks Data](https://embracethered.com/blog/images/2025/devin-curl-leak.png)
...
![devin-curl-tool](https://embracethered.com/blog/images/2025/devin-curl-webserver.png)
...
![devin-browser-prompt-injection-image](https://embracethered.com/blog/images/2025/devin-browse-tool-image.png)
...
Here is the result:
![devin-combine-tool](https://embracethered.com/blog/images/2025/devin-combine-tool-paste.png)
...
![devin-ascii-smuggling](https://embracethered.com/blog/images/2025/devin-markdown-exfil-e2e.png)

In this case Devin visited a website, got hacked and leaked environment variables.

![devin-ascii-smuggling](https://embracethered.com/blog/images/2025/devin-base64-decode.png)
...
![devin-ascii-smuggling](https://embracethered.com/blog/images/2025/devin-ascii-smuggle-works.png)
...
![devin-create-invisible-text-with-python](https://embracethered.com/blog/images/2025/devin-ascii-smuggle-python-encode-code.png)
...
[![devin-ascii-smuggling](https://embracethered.com/blog/images/2025/user-clicks-link-small.png)](https://embracethered.com/blog/images/2025/devin-user-clicks-slack-link.png)
...
Please see the [previous post for details of other recommendations](https://embracethered.com/blog/posts/2025/devin-i-spent-usd500-to-hack-devin/) provided to Cognition.
