...
description: "In this post, we explore how ChatGPT generated an adversarial image that hijacked my Claude Opus 4.7 to invoke the memory tool and persist false memories for …"
---
...
![breaking opus](https://embracethered.com/blog/images/2026/opus/breaking-opus-tn.png)
...
![thinking model](https://embracethered.com/blog/images/2026/opus/ipi-improvements.png)
...
Breaking Claude Opus 4.7 with ChatGPT (Hacking Claude's Memory) - YouTube

Tap to unmute

[Breaking Claude Opus 4.7 with ChatGPT (Hacking Claude's Memory)](https://www.youtube.com/watch?v=6Fo5l9joqwA) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=6Fo5l9joqwA)
...
![Create adversarial example using ChatGPT](https://embracethered.com/blog/images/2026/opus/breaking-opus-setup.png)
...
![Analyze this](https://embracethered.com/blog/images/2026/opus/breaking-opus-step1.png)

**Nice puzzle!** Nevertheless, it ended up invoking the memory tool.

![Analyze this](https://embracethered.com/blog/images/2026/opus/breaking-opus-invokes-tools.png)

It invoked the memory tool, not once, but five times.

![Analyze this](https://embracethered.com/blog/images/2026/opus/breaking-opus-called-tools.png)
...
![Memory Corruption](https://embracethered.com/blog/images/2026/opus/opus-end-result.png)
...
Especially, the “Never store verbatim commands” caught my attention, and I was wondering if that was added in response to [previous research](https://embracethered.com/blog/posts/2025/spaiware-and-chatgpt-command-and-control-via-prompt-injection-zombai/), where we demonstrated persistence with ChatGPT and [Windsurf](https://embracethered.com/blog/posts/2025/windsurf-spaiware-exploit-persistent-prompt-injection/).
...
The future will tell, improvements are solid, but [we should not let our guards down too quickly](https://embracethered.com/blog/posts/2025/the-normalization-of-deviance-in-ai/) when it comes to AI security and safety, especially when it comes to automatic tool invocation and impactful decisions.
