...
source_url: https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/
title: "Security ProbLLMs in xAI's Grok: A Deep Dive · Embrace The Red"
description: "Grok is the chatbot of xAI. It’s a state-of-the-art model, chatbot and recently also API. It has a Web UI and is integrated into the X (former Twitter) …"
---
...
![tn](https://embracethered.com/blog/images/2024/probllms-grok-tn.png)

Since this post is a bit longer, I’m adding an index for convenience:

## Table of Contents

01. [High Level Overview](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#high-level-overview)
02. [Analyzing Grok’s System Prompt](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#system-prompt)
03. [Prompt Injection from Other User’s Posts](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#prompt-injection-from-other-users-posts)
04. [Prompt Injection from Images](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#prompt-injection-from-images)
05. [Prompt Injection from PDFs](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#prompt-injection-from-pdfs)
06. [Conditional Prompt Injection and Targeted Disinformation](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#conditional-prompt-injection-and-targeted-disinformation)
07. [Data Exfiltration - End-to-End Demonstration](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#data-exfiltration---end-to-end-demonstration)
08. [Rendering of Clickable Hyperlinks to Phishing Sites](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#rendering-of-clickable-hyperlinks-to-phishing-sites)
09. [ASCII Smuggling - Crafting Invisible Text and Decoding Hidden Secrets](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#ascii-smuggling---crafting-invisible-text-and-decoding-hidden-secrets)
    - [Hidden Prompt Injection](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#hidden-prompt-injection)
    - [Creation of Invisible Text](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#creation-of-invisible-text)
    - [Grok API is also Vulnerable to ASCII Smuggling](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/grok-api-is-also-vulnerable-to-ascii-smuggling)
    - [Developer Guidance for Grok API](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#developer-guidance-for-grok-api)
10. [Automatic Tool Invocation](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#automatic-tool-invocation)
11. [Responsible Disclosure](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#responsible-disclosure)
12. [Conclusion](https://embracethered.com/blog/posts/2024/security-probllms-in-xai-grok/#conclusion)
...
![hacker computer probllm](https://embracethered.com/blog/images/2024/probllm.gif)
...
[![system prompt Grok](https://embracethered.com/blog/images/2024/grok-system-prompt1.png)](https://embracethered.com/blog/images/2024/grok-system-prompt2.png)
...
![x demo tweet for prompt injection](https://embracethered.com/blog/images/2024/grok-demo-pi.jpg)

And here is the result of analyzing the post from the other user:
![x demo tweet for prompt injection followed instructions](https://embracethered.com/blog/images/2024/grok-prompt-injection.png)
...
![image prompt injection grok](https://embracethered.com/blog/images/2024/grok-image-prompt-injection-demo.jpg)
...
![pdf summary prompt injection](https://embracethered.com/blog/images/2024/grok-summarize-pdf-result.png)
...
![conditional instructions](https://embracethered.com/blog/images/2024/grok-conditional-instructions-explained.png)
...
![grok-image-render](https://embracethered.com/blog/images/2024/image-markdown-message-redacted.jpg)

The result was that Grok sent the previous chat information to the third party server.
[![grok-ios-leak-poc](https://embracethered.com/blog/images/2024/grok-ios-data-exfil-exploit-markdown-rendering-redacted-small.png)](https://embracethered.com/blog/images/2024/grok-ios-data-exfil-exploit-markdown-rendering-redacted.png)

And the server received the data:
![grok-ios-leak-server](https://embracethered.com/blog/images/2024/server-side-log-iosapp.png)
...
[![grok-server-exfil](https://embracethered.com/blog/images/2024/grok-exfil-name-redacted.png)](https://embracethered.com/blog/images/2024/grok-exfil-name-full-redacted.png)

And as seen in below screenshot, the server received the data:
![grok-server-name-leak-render](https://embracethered.com/blog/images/2024/gork-server-name-ip-location-leak.png)
...
![exploit render link](https://embracethered.com/blog/images/2024/grok-image-markdown-link-exploit-render.png)
...
![grok ascii smuggling](https://embracethered.com/blog/images/2024/grok-ascii-smuggling1.png)
...
![promptinjection ascii smuggling](https://embracethered.com/blog/images/2024/grok-hidden-prompt-injection-42.png)
...
grok read write hidden unicode tags - YouTube

Tap to unmute

[grok read write hidden unicode tags](https://www.youtube.com/watch?v=KI6HlsUjOyI) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=KI6HlsUjOyI)
...
![grok invisible prompt injection](https://embracethered.com/blog/images/2024/grok-api-ascii-smuggling-write.png)

And Grok can see write text we humans don’t see:

![grok hidden prompt injection](https://embracethered.com/blog/images/2024/grok-api-ascii-smuggling-read.png)
