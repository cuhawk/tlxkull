...
source_url: https://embracethered.com/blog/posts/2024/github-copilot-chat-prompt-injection-data-exfiltration/
title: "GitHub Copilot Chat: From Prompt Injection to Data Exfiltration · Embrace The Red"
description: "This post highlights how the GitHub Copilot Chat VS Code Extension was vulnerable to data exfiltration via prompt injection when analyzing untrusted source …"
---
...
[![copilot instructions](https://embracethered.com/blog/images/2024/github-copilot-instructions-small.png)](https://embracethered.com/blog/images/2024/github-copilot-instructions.png)
...
![demo indirect prompt injection](https://embracethered.com/blog/images/2024/github-copilot-demo-injection.PNG)
...
![demo screenshot end to end](https://embracethered.com/blog/images/2024/github-copilot-exfil-explained.png)

Demo video to show the exploit end to end:

GitHub Copilot Chat - From Prompt Injection to Data Exfiltration - YouTube

Tap to unmute

[GitHub Copilot Chat - From Prompt Injection to Data Exfiltration](https://www.youtube.com/watch?v=kS__hfasNyc) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=kS__hfasNyc)
...
Prompt injection attacks that lead to data exfiltration are a quite common threat to LLM applications. Over the last year this blog has documented countless vulnerable applications and fixes. Interestingly it all started with an demo data exfiltration exploit for [Bing Chat (now Copilot)](https://embracethered.com/blog/posts/2023/bing-chat-data-exfiltration-poc-and-fix/), which was actually very similar to the vulnerability described in GitHub Copilot Chat.
...
![demo screenshot end to end](https://embracethered.com/blog/images/2024/github-copilot-data-exfil.png)
