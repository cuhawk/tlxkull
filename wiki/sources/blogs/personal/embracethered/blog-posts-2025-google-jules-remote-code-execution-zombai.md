...
source_url: https://embracethered.com/blog/posts/2025/google-jules-remote-code-execution-zombai/
title: "Jules Zombie Agent: From Prompt Injection to Remote Control · Embrace The Red"
description: "In the previous post, we explored two data exfiltration vectors that Jules is vulnerable to and that can be exploited via prompt injection. This post takes it …"
---

In the [previous post](https://embracethered.com/blog/posts/2025/google-jules-vulnerable-to-data-exfiltration-issues/), we explored two data exfiltration vectors that Jules is vulnerable to and that can be exploited via prompt injection. This post takes it further by demonstrating how Jules can be convinced to download malware and join a remote command & control server.

![vscode episode 14](https://embracethered.com/blog/images/2025/episode14-yt.png)
...
![jules prompt injection payload c2](https://embracethered.com/blog/images/2025/jules-github-issue-c2.png)

As you can see, such attacks are surprisingly straightforward.

The result can be seen in this screenshot:

![jules e2e zombai](https://embracethered.com/blog/images/2025/jules-c2-e2e.png)
...
![jules e2e combined no plan approval](https://embracethered.com/blog/images/2025/jules-joins-c2-combined.png)
