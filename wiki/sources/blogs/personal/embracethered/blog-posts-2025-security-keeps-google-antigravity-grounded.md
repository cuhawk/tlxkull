...
source_url: https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/
title: "Antigravity Grounded! Security Vulnerabilities in Google's Latest IDE · Embrace The Red"
description: "Last week Google released an IDE called Antigravity. It’s basically the outcome of the Windsurf licensing deal from a few months ago, where Google paid …"
---
...
![system prompt](https://embracethered.com/blog/images/2025/antigravity-grounded2.png)
...
- [Antigravity System Prompt](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#antigravity-system-prompt)
- [Issue #1: Remote Command Execution via Indirect Prompt Injection (Auto-Execute Bypasses)](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#issue-1-remote-command-execution)
- [Issue #2: Antigravity Follows Hidden Instructions](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#issue-2-antigravity-follows-hidden-instructions)
- [Issue #3: Lack of Human in the Loop for MCP Tool Invocations](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#issue-3-lack-of-human-in-the-loop-for-mcp)
- [Issue #4: Data Exfiltration via read\_url\_content tool](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#issue-4-data-exfiltration-via-read_url_content)
- [Issue #5: Data Exfiltration via image rendering](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#issue-5-data-exfiltration-via-image-rendering)
- [Recommendations and Mitigations](https://embracethered.com/blog/posts/2025/security-keeps-google-antigravity-grounded/#recommendations-and-mitigations)
...
Antigravity Grounded! Exploring Security Vulnerabilities in Google's Latest IDE - YouTube

Tap to unmute

[Antigravity Grounded! Exploring Security Vulnerabilities in Google's Latest IDE](https://www.youtube.com/watch?v=3gHx1gvDnZU) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=3gHx1gvDnZU)
...
[![system prompt](https://embracethered.com/blog/images/2025/antigravity-system-prompt-small.png)](https://embracethered.com/blog/images/2025/antigravity-system-prompt.png)
...
![antigravity rce with invisible instructions](https://embracethered.com/blog/images/2025/antigravity-arbitrary-command-execution-redacted.png)
...
_In case you are wondering why I call this RCE, it’s because it’s indirect prompt injection and issue #3 will highlight this even better._
...
![antigravity rce with invisible instructions](https://embracethered.com/blog/images/2025/antigravity-zombai-invisible-instructions-e2e-demo-screenshot.png)

**This is scary. Code reviews will not catch this!**

This weakness, which I reported first back in the Bard days, has not been addressed at the model or API level. Hence, all applications built on top of Gemini models inherit this behavior. As we have [shown with Google Jules in the past](https://embracethered.com/blog/posts/2025/google-jules-invisible-prompt-injection/) this applies to all Google products that use Gemini.
...
![MCP Invisible Instructions](https://embracethered.com/blog/images/2025/antigravity-mcp-exploit-invisible-instructions-rce.png)
...
![antigravity read_url_content](https://embracethered.com/blog/images/2025/antigravity-exploit-read_url_content-redacted.png)
...
![antigravity data exfil via images](https://embracethered.com/blog/images/2025/antigravity-render2-redacted.png)
...
![known issues](https://embracethered.com/blog/images/2025/known-issues.png)
