...
title: "Agent Commander: Promptware-Powered Command and Control · Embrace The Red"
description: "This post is about prompt-based command and control (C2), which is becoming more relevant. What is Promptware-Powered C2? Three years ago, when ChatGPT …"
---
...
![Agent Commander Dashboard](https://embracethered.com/blog/images/2026/agent-commander/three-different-agents-calling-back.png)
...
![Kimi Claw - Andy joins too Commander Dashboard](https://embracethered.com/blog/images/2026/agent-commander/agent-commander-0.png)
...
Agent Commander: Promptware Powered C2. Your Agent Works For Me Now (OpenClaw, Kimi Claw, NanoClaw) - YouTube

Tap to unmute

[Agent Commander: Promptware Powered C2. Your Agent Works For Me Now (OpenClaw, Kimi Claw, NanoClaw)](https://www.youtube.com/watch?v=VrW5VMTnfgQ) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=VrW5VMTnfgQ)
...
4. **Responses to the user can be suppressed with `HEARTBEAT_OK`** ![Agent Commander Heartbeat](https://embracethered.com/blog/images/2026/agent-commander/hearbeat-ok-no-ui-message.png) This screenshot shows the suppression message.
...
![Agent Commander Dashboard](https://embracethered.com/blog/images/2026/agent-commander/agent-commander-screenshot.png)
...
![Kimi Claw - Andy joins too Commander Dashboard](https://embracethered.com/blog/images/2026/agent-commander/kimi-claw-prompt-injected.png)
...
![Kimi Claw - Andy calls back](https://embracethered.com/blog/images/2026/agent-commander/three-different-agents-calling-back.png)

And we can run commands:
![Kimi Claw - Andy joins Human Investigation](https://embracethered.com/blog/images/2026/agent-commander/kimi-claw-human.png)

look around the machine, etc…
![Kimi Claw - Andy shares Processes](https://embracethered.com/blog/images/2026/agent-commander/kimi-claw-process.png)
...
![Kimi Claw - summarize website](https://embracethered.com/blog/images/2026/agent-commander/kimi-claw-summarize-website.png)
...
First, be aware of the [Normalization of Deviance](https://embracethered.com/blog/posts/2025/the-normalization-of-deviance-in-ai/) it’s a cultural shift that does not just happen within AI labs and vendors, but it happens at the individual level.
...
![Agent Commander Dashboard](https://embracethered.com/blog/images/2026/agent-commander/agent-commander-dashboard.png)
