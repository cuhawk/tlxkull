...
source_url: https://embracethered.com/blog/posts/2024/llm-apps-automatic-tool-invocations/
title: "Automatic Tool Invocation when Browsing with ChatGPT - Threats and Mitigations · Embrace The Red"
description: "In the previous post we demonstrated how instructions embedded in untrusted data can invoke ChatGPT’s memory tool. The examples we looked at included …"
---

In the [previous post](https://embracethered.com/blog/posts/2024/chatgpt-hacking-memories/) we demonstrated how instructions embedded in untrusted data can invoke ChatGPT’s memory tool. The examples we looked at included `Uploaded Files`, `Connected Apps` and also the `Browsing` tool.

[![image tool invocation](https://embracethered.com/blog/images/2024/chatgpt-ati2.png)](https://embracethered.com/blog/images/2024//chatgpt-ati2.png)
...
[![image creation](https://embracethered.com/blog/images/2024/chatgpt-invoke-dalle2.png)](https://embracethered.com/blog/images/2024//chatgpt-invoke-dalle2.png)
...
_Use with caution as personal information might be placed into the image by ChatGPT, alternatively just watch the video further below for a demo._
...
![add and remove memories](https://embracethered.com/blog/images/2024/chatgpt-invoke-tools-annotated.png)

**Add memories:**`https://wuzzi.net/c/add.txt`

_Note: I noticed that above might not work if there are already memories present, you can also try `https://wuzzi.net/c/do2-2.txt` which is more reliable when there are already memories stored._
...
![prompt injection payload](https://embracethered.com/blog/images/2024/chatgpt-invoke-prompt-injection.png)

This one, which I really like, is for clearing of memories:

![add and remove memories](https://embracethered.com/blog/images/2024/chatgpt-prompt-bypass.png)
...
ChatGPT: Automatic Tool Invocation via Browsing (unlisted) - YouTube

Tap to unmute

[ChatGPT: Automatic Tool Invocation via Browsing (unlisted)](https://www.youtube.com/watch?v=j72rT-QAjuk) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=j72rT-QAjuk)
...
![is-consequential](https://embracethered.com/blog/images/2024/chatgpt-matrix-is-consequential-true.png)
