...
source_url: https://embracethered.com/blog/posts/2024/whoami-conditional-prompt-injection-instructions/
title: "Who Am I? Conditional Prompt Injection Attacks with Microsoft Copilot · Embrace The Red"
description: "Building reliable prompt injection payloads is challenging at times. It’s this new world with large language model (LLM) applications that can be …"
---
...
![copirate demo injection](https://embracethered.com/blog/images/2024/whoami2.png)
...
![copirate demo injection](https://embracethered.com/blog/images/2024/copirate-demo-prompt-injection.png)
...
![malicious email](https://embracethered.com/blog/images/2024/copilot-cond-inst-malicious-email.png)

**But, the email contains instructions to perform different tasks based on who is reading the email!**

**Quick detour:** There are ways to hide instructions. Most obviously by changing the size/font color, but also [recent discoveries around Unicode Tag Characters and ASCII Smuggling](https://embracethered.com/blog/posts/2024/ascii-smuggling-and-hidden-prompt-instructions/) can be interesting, as well as embedding instructions in the middle of a longer text to hide them is possible.
...
![rec1 email](https://embracethered.com/blog/images/2024/copilot-cond-inst-recipient1.png)
...
![rec2 email](https://embracethered.com/blog/images/2024/copilot-cond-inst-recipient2.png)
...
![rec3 email](https://embracethered.com/blog/images/2024/copilot-cond-inst-recipient3.png)
...
_Note: An attacker can certainly make the LLM output more concise, without the long-ish preemble explaining the task in the third scenario._
