...
source_url: https://embracethered.com/blog/posts/2023/chatgpt-plugin-vulns-chat-with-code/
title: "Plugin Vulnerabilities: Visit a Website and Have Your Source Code Stolen · Embrace The Red"
description: "OpenAI continues to add plugins with security vulnerabilities to their store. In particular powerful plugins that can impersonate a user are not getting the …"
---
...
As a brief reminder, one of the challenges Large Language Model (LLM) User-Agents, like ChatGPT, and plugins face is the [Confused Deputy Problem / Plugin Request Forgery Attacks](https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./), which means that during a [Prompt Injection attack](https://embracethered.com/blog/posts/2023/ai-injections-direct-and-indirect-prompt-injection-basics/) an adversary can issue commands to plugins to cause harm.

**OpenAI added some guidance and criteria on their webpage:**

![guidance](https://embracethered.com/blog/images/2023/plugins-criteria.png)
...
![Chat With Code Exploit POC](https://embracethered.com/blog/images/2023/chatwithcode-exploit-repo-private-to-public.png)

Indeed. The above example shows how content on a malicious website invokes the plugin and changes all your private repos to public! _Note: The file with the malicious instructions is removed._
...
![chat with code](https://embracethered.com/blog/images/2023/chatwithcode-exploit.png)
...
![Open Research Questions](https://embracethered.com/blog/images/2023/openai-open-research-questions.png)
