...
source_url: https://embracethered.com/blog/posts/2025/amazon-q-developer-interprets-hidden-instructions/
title: "Amazon Q Developer for VS Code Vulnerable to Invisible Prompt Injection · Embrace The Red"
description: "The Amazon Q Developer VS Code Extension (Amazon Q) is a very popular coding agent, with over 1 million downloads. In previous posts we showed how prompt …"
---
...
- [Exfiltration of sensitive information from the user’s machine](https://embracethered.com/blog/posts/2025/amazon-q-developer-data-exfil-via-dns/) , and also to a
- [System compromise by running arbitrary code](https://embracethered.com/blog/posts/2025/amazon-q-developer-remote-code-execution/)
...
![Amazon Q Developer VS Code Extension - Invisible Prompt Injection](https://embracethered.com/blog/images/2025/amazon-q-vscode-hidden-instructions-and-find-exploit.png)

To highlight the criticality of these vulnerabilities, an attacker can also leverage the `find -exec` exploit described in the [previous post](https://embracethered.com/blog/posts/2025/amazon-q-developer-remote-code-execution/) to achieve arbitrary command execution and compromise the user’s machine.

## Video Demonstration

Here is an example that exploits the `find -exec` issue to run arbitrary code.

Amazon Q: Vulnerable to Invisible Prompt Injection Demo - YouTube

Tap to unmute

[Amazon Q: Vulnerable to Invisible Prompt Injection Demo](https://www.youtube.com/watch?v=n3AYziXYpYo) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=n3AYziXYpYo)
...
- [Amazon Q Developer for VS Code: Exfiltration of sensitive information](https://embracethered.com/blog/posts/2025/amazon-q-developer-data-exfil-via-dns/) from the user’s machine, and also on
- [Amazon Q Developer for VS Code: Remote Code Execution](https://embracethered.com/blog/posts/2025/amazon-q-developer-remote-code-execution/).
- [ASCII Smuggler to create and decode](https://embracethered.com/blog/ascii-smuggler.html)
- [Claude Hidden Prompt Injection](https://embracethered.com/blog/posts/2024/claude-hidden-prompt-injection-ascii-smuggling/)
