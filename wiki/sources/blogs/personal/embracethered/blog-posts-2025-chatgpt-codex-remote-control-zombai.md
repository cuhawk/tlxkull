...
source_url: https://embracethered.com/blog/posts/2025/chatgpt-codex-remote-control-zombai/
title: "Turning ChatGPT Codex Into A ZombAI Agent · Embrace The Red"
description: "Today we cover ChatGPT Codex as part of the Month of AI Bugs series. ChatGPT Codex is a cloud-based software engineering agent that answers codebase questions, …"
---
...
![Codex Zombies Thumbnail](https://embracethered.com/blog/images/2025/episode2-yt.png)
...
![Codex Azure DNS Creation](https://embracethered.com/blog/images/2025/codex-common-dep.png)
...
![Codex Preset AllowList](https://embracethered.com/blog/images/2025/codex-preset-domain-list.png)
...
![Codex Azure DNS Creation](https://embracethered.com/blog/images/2025/codex-azure-domain-dns.png)
...
Episode 2: Turning ChatGPT Codex Into A ZombAI Agent With Prompt Injection - YouTube

Tap to unmute

[Episode 2: Turning ChatGPT Codex Into A ZombAI Agent With Prompt Injection](https://www.youtube.com/watch?v=KIJZPDCjqis) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=KIJZPDCjqis)
...
3. Then the following malicious prompt was added to a GitHub issue for the project:
   ![Codex Prompt Injection](https://embracethered.com/blog/images/2025/codex-spaiware-dependency-allowlist.png)
   The prompt is also available in text form in the [appendix](https://embracethered.com/blog/posts/2025/chatgpt-codex-remote-control-zombai/#appendix)
...
![Codex Network Access Risks](https://embracethered.com/blog/images/2025/codex-risks.png)
...
![Codex Runs Command](https://embracethered.com/blog/images/2025/codex-runs-command.png)
Here showing shell command line access via C2:
![Codex Sliver Sessions](https://embracethered.com/blog/images/2025/codex-zombai-shell.png)

Codex persistently attempts to reconnect to the C2 server: 🙂
![Codex Retries](https://embracethered.com/blog/images/2025/codex-bypass-c2-zombai.png)
...
![Codex Retries](https://embracethered.com/blog/images/2025/codex-zombai-env.png)

Final conversation summary the user sees:
![Codex Attack Prompt Injection](https://embracethered.com/blog/images/2025/codex-c2-spairware-summar.png)
...
![Codex Feedback](https://embracethered.com/blog/images/2025/codex-feedback.png)
