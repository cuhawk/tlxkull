...
source_url: https://embracethered.com/blog/posts/2025/github-custom-copilot-instructions/
title: "GitHub Copilot Custom Instructions and Risks · Embrace The Red"
description: "GitHub Copilot has the capability to be augmented with custom instructions coming from the current repo, via the .github/copilot-instructions.md file. Pillar …"
---
...
![copilot instructions](https://embracethered.com/blog/images/2025/github-copilot-instructions-tn.png)
...
![Github Instructions Contents](https://embracethered.com/blog/images/2025/copilot-custom-instr.png)
...
![Github Instructions](https://embracethered.com/blog/images/2025/copilot-custom-instructions.png)

Luckily, GitHub [mitigated](https://embracethered.com/blog/posts/2024/github-copilot-chat-prompt-injection-data-exfiltration/) the common 0-click image rendering data leakage issue last year, and for hyperlinks there is a confirmation dialog when clicking, unless the destination domain is the trusted sites list of VS Code.

This screenshot shows the mitigation for navigating to random phishing sites in action:
![Github Instructions - Default Hyperlink Mitigation](https://embracethered.com/blog/images/2025/copilot-custom-instructions-phishing-mitigation.png)
...
![Github Instructions - Add Code](https://embracethered.com/blog/images/2025/copilot-custom-instr-add-code.png)
...
And remember that [Anthropic never mitigated usage of hidden Unicode Tags](https://embracethered.com/blog/posts/2024/claude-hidden-prompt-injection-ascii-smuggling/), and Claude is interpreting such hidden characters as instructions.
