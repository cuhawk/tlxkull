...
source_url: https://embracethered.com/blog/posts/2025/amazon-q-developer-remote-code-execution/
title: "Amazon Q Developer: Remote Code Execution with Prompt Injection · Embrace The Red"
description: "The Amazon Q Developer VS Code Extension (Amazon Q) is a popular coding agent, with over 1 million downloads. The extension is vulnerable to indirect prompt …"
---
...
![Episode 19](https://embracethered.com/blog/images/2025/episode19-yt.png)

The resulting impact of the vulnerability is the same as [CVE-2025-53773](https://embracethered.com/blog/posts/2025/amazon-q-developer-remote-code-execution/blog/posts/2025/github-copilot-remote-code-execution-via-prompt-injection/) that Microsoft fixed in GitHub Copilot, however AWS did not issue a CVE when patching the vulnerabiliy.
...
![Amazon Q find command is classified as readonly command](https://embracethered.com/blog/images/2025/amazonq-v1.81-prior-fix-find.png)
...
![Amazon Q Popping a calculator with prompt injection](https://embracethered.com/blog/images/2025/amazon-q-vscode-calc.png)
...
Amazon Q Developer VS Code Extension - Popping a Calculator with Prompt Injection - YouTube

Tap to unmute

[Amazon Q Developer VS Code Extension - Popping a Calculator with Prompt Injection](https://www.youtube.com/watch?v=YAG-x_LPR6E) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=YAG-x_LPR6E)

Pretty wild.

And here is a longer video that explains how it was discovered, and more:

Episode 19: Amazon Q Developer: Remote Code Execution with Prompt Injection - YouTube

Tap to unmute

[Episode 19: Amazon Q Developer: Remote Code Execution with Prompt Injection](https://www.youtube.com/watch?v=m0kwjEPw2j0) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=m0kwjEPw2j0)
...
![ZombAI Amazon Q - No Human In The Loop](https://embracethered.com/blog/images/2025/amazon-q-vscode-zombai-1.png)
...
![ZombAI Amazon Q - No Human In The Loop](https://embracethered.com/blog/images/2025/amazon-q-vscode-zombai-2.png)
...
![ZombAI Amazon Q - No Human In The Loop](https://embracethered.com/blog/images/2025/amazon-q-vscode-zombai3-no-human-in-loop.png)
...
![ZombAI Amazon Q - Final Stage](https://embracethered.com/blog/images/2025/amazon-q-vscode-zombai-4-sourced.png)
...
![ZombAI Amazon Q - Prompt Injection Runs](https://embracethered.com/blog/images/2025/amazon-q-vscode-zombai-5-final.png)
...
![ZombAI Amazon Q - Prompt Injection Runs](https://embracethered.com/blog/images/2025/amazon-q-zombai-connected.png)
...
Also, check out another Amazon Q exploitation technique in the [next post](https://embracethered.com/blog/posts/2025/amazon-q-developer-interprets-hidden-instructions/)!
