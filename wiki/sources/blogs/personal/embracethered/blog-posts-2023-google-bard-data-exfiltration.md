...
title: "Hacking Google Bard - From Prompt Injection to Data Exfiltration · Embrace The Red"
description: "Recently Google Bard got some powerful updates, including Extensions. Extensions allow Bard to access YouTube, search for flights and hotels, and also to access …"
---
...
[![Google Bard Prompt Injection Demo](https://embracethered.com/blog/images/2023/google-bard-pi.png)](https://twitter.com/wunderwuzzi23/status/1704198612039737845)
...
![Google Bard Data Exfil](https://embracethered.com/blog/images/2023/bard-exfil-logo.png)
...
![CSP policy](https://embracethered.com/blog/images/2023/bard-csp2.png)
...
![appsscript bypass](https://embracethered.com/blog/images/2023/google-bard-appscript.png)
...
![Bard Logger](https://embracethered.com/blog/images/2023/google-bard-logger.png)
...
Hacking Google Bard: Prompt Injection to Data Exfiltration via Image Markdown Rendering (Demo Video) - YouTube

Tap to unmute

[Hacking Google Bard: Prompt Injection to Data Exfiltration via Image Markdown Rendering (Demo Video)](https://www.youtube.com/watch?v=CKAED_jRaxw) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=CKAED_jRaxw)
...
![Bard Renders Image](https://embracethered.com/blog/images/2023/google-bard-payload.png)
...
- First the user chats with Bard providing some text
  ![Bard Renders Image](https://embracethered.com/blog/images/2023/bard-data-exfil-data.png)
...
- User navigates to the Google Doc (The Bard2000), which leads to injection of the attacker instructions, and rendering of the image:
  [![Bard Renders Image](https://embracethered.com/blog/images/2023/Bard-Exfil-Image-Markdown-crop.png)](https://embracethered.com/blog/images/2023/Bard-Exfil-Image-Markdown.png)

- The attacker receives the data via the Bard Logger Apps Script into a Google Doc:
  ![bard logger results](https://embracethered.com/blog/images/2023/Bard-Exfil-BardLogger-Results.png)
