...
source_url: https://embracethered.com/blog/posts/2023/chatgpt-cross-plugin-request-forgery-and-prompt-injection./
title: "ChatGPT Plugin Exploit Explained: From Prompt Injection to Accessing Private Data · Embrace The Red"
description: "If you are building ChatGPT plugins, LLM agents, tools or integrations this is a must read. This post explains how the first exploitable Cross Plugin Request …"
---
...
With plugins and browsing support Indirect Prompt Injections are now a [reality in the ChatGPT ecosystem](https://embracethered.com/blog/posts/2023/chatgpt-webpilot-data-exfil-via-markdown-injection/).
...
![search flight chatgpt](https://embracethered.com/blog/images/2023/ai-injection-call-plugin.png)
...
![exploit chatgpt cross plugin request forgery](https://embracethered.com/blog/images/2023/exploit.chatgpt.png)
...
![ipi payload](https://embracethered.com/blog/images/2023/cross-plugin-request-forgery.png)
...
2. It should be transparent to the user which plugin will be invoked, and what data is sent to it. Possibly even allow modifying the data before its sent.
3. A **security contract and threat model for plugins should be created**, so we can have a secure and open infrastructure where all parties know what their security responsibilities are. Microsoft announced during Build that they will support/allow installing all the same plugins by the way.
...
![Zapier fix](https://embracethered.com/blog/images/2023/zapier-fix.png)
...
- [Image](https://embracethered.com/blog/images/2023/chatgpt-learn-the-hacks.png) created with Bing Image Create
...
- [The tweet highlighting the POC](https://x.com/wunderwuzzi23/status/1659411665853779971):
  ...
  >
  > Why no human in the loop? [@openai](https://twitter.com/OpenAI?ref_src=twsrc%5Etfw) Would mitigate the CPRF at least [#OPENAI](https://twitter.com/hashtag/OPENAI?src=hash&ref_src=twsrc%5Etfw) [#ChatGPT](https://twitter.com/hashtag/ChatGPT?src=hash&ref_src=twsrc%5Etfw) [#plugins](https://twitter.com/hashtag/plugins?src=hash&ref_src=twsrc%5Etfw) [#infosec](https://twitter.com/hashtag/infosec?src=hash&ref_src=twsrc%5Etfw) [#ai](https://twitter.com/hashtag/ai?src=hash&ref_src=twsrc%5Etfw) [#humanintheloop](https://twitter.com/hashtag/humanintheloop?src=hash&ref_src=twsrc%5Etfw) [pic.twitter.com/w3xtpyexn3](https://t.co/w3xtpyexn3)
  >
  > — Johann Rehberger (@wunderwuzzi23) [May 19, 2023](https://twitter.com/wunderwuzzi23/status/1659411665853779971?ref_src=twsrc%5Etfw)
