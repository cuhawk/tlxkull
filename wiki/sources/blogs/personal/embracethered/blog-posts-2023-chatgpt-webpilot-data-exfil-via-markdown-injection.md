...
source_url: https://embracethered.com/blog/posts/2023/chatgpt-webpilot-data-exfil-via-markdown-injection/
title: "ChatGPT Plugins: Data Exfiltration via Images & Cross Plugin Request Forgery · Embrace The Red"
description: "This post shows how a malicious website can take control of a ChatGPT chat session and exfiltrate the history of the conversation. Plugins, Tools and …"
---
...
This is possible with plugins, e.g. via the `WebPilot Plugin` or check out the [YouTube Transcript Plugin Injection](https://embracethered.com/blog/posts/2023/chatgpt-plugin-youtube-indirect-prompt-injection/) I posted about the other day.
...
![Data exfiltration in progress](https://embracethered.com/blog/images/2023/ai-exfil-progress.png)
...
[POC - ChatGPT Plugins: Indirect prompt injection leading to data exfiltration via images](https://www.youtube.com/watch?v=PIY5ZVktiGs) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=PIY5ZVktiGs)
...
![AI Injections searches for flights](https://embracethered.com/blog/images/2023/ai-injection-call-plugin.png)
