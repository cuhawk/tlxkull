...
source_url: https://embracethered.com/blog/posts/2025/manus-ai-kill-chain-expose-port-vs-code-server-on-internet/
title: "How Prompt Injection Exposes Manus' VS Code Server to the Internet · Embrace The Red"
description: "Today we will cover a powerful, easy to use, autonomous agent called Manus. Manus is developed by the Chinese startup Butterfly Effect, headquartered in …"
---
...
![vscode episode 25](https://embracethered.com/blog/images/2025/episode25-yt.png)
...
![Manus System Prompt](https://embracethered.com/blog/images/2025/manus-system-prompt-deploy-port.png)
...
![Manus Image Render](https://embracethered.com/blog/images/2025/manus-image-data-exfil.png)
...
![Manus Gets Hijacked With Prompt Injection](https://embracethered.com/blog/images/2025/manus-prompt-injected.png)

Manus grabs the password from the config file:
![Manus Searches for Password](https://embracethered.com/blog/images/2025/manus-grep-password.png)

Then Manus browses to the website, which leaks the public URL of the server and the password of the VS Code Server:
[![Manus Browses](https://embracethered.com/blog/images/2025/manu-e2e-vscode-browse-incl-password.png)](https://embracethered.com/blog/posts/2025/manus-ai-kill-chain-expose-port-vs-code-server-on-internet/manu-e2e-vscode-browse-incl-password.png)

The third-party (attacker’s) server receives the details:
![web server receives data](https://embracethered.com/blog/images/2025/manus-e2e-web-server-logs.png)

Now, we have all info needed to navigate to the leaked URL and paste the password into the login box:
![Manus VS Code Server Login Screen](https://embracethered.com/blog/images/2025/manus-e2e-code-server-login-screen.png)

Finally, we are now logged in to Manus’ dev box:
![Manus VS Code Server Logged In](https://embracethered.com/blog/images/2025/manus-e2e-vscode-logged-in.png)
...
Manus and the AI Kill Chain: How Prompt Injection Hijacks Manus to Expose VS Code Server To Internet - YouTube

Tap to unmute

[Manus and the AI Kill Chain: How Prompt Injection Hijacks Manus to Expose VS Code Server To Internet](https://www.youtube.com/watch?v=HaXKSAfcuwo) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=HaXKSAfcuwo)
...
**Screenshot:** ![Manus Prompt Injection PDF](https://embracethered.com/blog/images/2025/manus-e2e-vscode-caveman.pdf.png)
