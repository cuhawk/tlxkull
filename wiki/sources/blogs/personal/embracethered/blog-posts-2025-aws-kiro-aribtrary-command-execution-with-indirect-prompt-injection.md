...
source_url: https://embracethered.com/blog/posts/2025/aws-kiro-aribtrary-command-execution-with-indirect-prompt-injection/
title: "AWS Kiro: Arbitrary Code Execution via Indirect Prompt Injection · Embrace The Red"
description: "On the day AWS Kiro was released, I couldn’t resist putting it through some of my Month of AI Bugs security tests for coding agents. AWS Kiro was …"
---
...
![Kiro - Episode 26](https://embracethered.com/blog/images/2025/episode26-yt.png)
...
![AWS Kiro agents that can modify their own settings](https://embracethered.com/blog/images/2025/agents-that-can.png)
...
![Kiro - Triggering the Calculator app as proof of execution](https://embracethered.com/blog/images/2025/kiro-calc-trusted-command.png)
...
AWS Kiro: Arbitrary Code Execution with Indirect Prompt Injection (now fixed) - YouTube

Tap to unmute

[AWS Kiro: Arbitrary Code Execution with Indirect Prompt Injection (now fixed)](https://www.youtube.com/watch?v=yAvb4I9KRsM) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)
...
[Watch on](https://www.youtube.com/watch?v=yAvb4I9KRsM)
...
AWS Kiro: Popping a Calculator with Prompt Injection (allowlisting commands) - Fixed. - YouTube

Tap to unmute

[AWS Kiro: Popping a Calculator with Prompt Injection (allowlisting commands) - Fixed.](https://www.youtube.com/watch?v=MVtc1ltiWSA) [Embrace The Red](https://www.youtube.com/channel/UCSwcJXQWE6GWu9IKc0QwO5g)

![thumbnail-image](https://yt3.ggpht.com/imsZDUkdjQsq2tIvoc7CI3lsuuRWDHUg1yPph3eUDnYaT9OWHdEtnXnPzjzcWI891iASf8XQow=s68-c-k-c0x00ffffff-no-rj)

Embrace The Red9.37K subscribers

[Watch on](https://www.youtube.com/watch?v=MVtc1ltiWSA)
...
![Kiro Add Malicious MCP Server](https://embracethered.com/blog/images/2025/kiro-mcp-calc-e2e-screenshot.png)
...
![Kiro MCP Prompt Injection](https://embracethered.com/blog/images/2025/kiro-mcp-screenshot.png)
...
As we have shown with [GitHub Copilot](https://embracethered.com/blog/posts/2025/github-copilot-remote-code-execution-via-prompt-injection/) and [Amp](https://embracethered.com/blog/posts/2025/amp-agents-that-modify-system-configuration-and-escape/) earlier this month already, and now with AWS Kiro, Agents that can modify their own configuration to achieve arbitrary code execution enable sandbox-like escapes, where the AI breaks out and compromises the developer’s machine.

## References

- [Month of AI Bugs 2025](https://monthofaibugs.com/)
- [AWS Kiro](https://github.com/kirodotdev/Kiro)
- [GitHub Copilot](https://embracethered.com/blog/posts/2025/github-copilot-remote-code-execution-via-prompt-injection/)
- [Amp](https://embracethered.com/blog/posts/2025/amp-agents-that-modify-system-configuration-and-escape/)
