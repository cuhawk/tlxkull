---
source: zlz-buerhaus
source_url: https://buer.haus/2018/10/08/h1-5411-ctf-write-up-by-erbbysam-and-ziot/
title: "H1-5411 CTF Write-up by erbbysam and ziot | ziot"
---

[< Back](https://buer.haus/)

[![](http://buer.haus/wp-content/uploads/2018/10/h15411-300x209.png)](http://buer.haus/wp-content/uploads/2018/10/h15411.png)

Authors:

- [Sam Erb](https://twitter.com/erbbysam)
...
> We bring the memes! First 10 winners get a ticket to hack with us at h1-5411 on Saturday for up to $150K in bounties! [#h15411](https://twitter.com/hashtag/h15411?src=hash&ref_src=twsrc%5Etfw) [#memeCTF](https://twitter.com/hashtag/memeCTF?src=hash&ref_src=twsrc%5Etfw) [#eko14](https://twitter.com/hashtag/eko14?src=hash&ref_src=twsrc%5Etfw) [#togetherwehitharder](https://twitter.com/hashtag/togetherwehitharder?src=hash&ref_src=twsrc%5Etfw) [pic.twitter.com/hDvnehMxou](https://t.co/hDvnehMxou)
>
> — HackerOne (@Hacker0x01) [September 26, 2018](https://twitter.com/Hacker0x01/status/1044974142150373378?ref_src=twsrc%5Etfw)

This leads you to the CTF website:

- [https://h1-5411.h1ctf.com/](https://h1-5411.h1ctf.com/)
...
[![](http://buer.haus/wp-content/uploads/2018/10/2-300x115.png)](http://buer.haus/wp-content/uploads/2018/10/2.png)
...
[![](http://buer.haus/wp-content/uploads/2018/10/3-300x75.png)](http://buer.haus/wp-content/uploads/2018/10/3.png)
...
[![](http://buer.haus/wp-content/uploads/2018/10/4-300x65.png)](http://buer.haus/wp-content/uploads/2018/10/4.png)

Here you can see the source code when viewing your saved memes:

[![](http://buer.haus/wp-content/uploads/2018/10/5-300x173.png)](http://buer.haus/wp-content/uploads/2018/10/5.png)
...
[![](http://buer.haus/wp-content/uploads/2018/10/6-300x157.png)](http://buer.haus/wp-content/uploads/2018/10/6.png)

That means the DOMDocument->loadXML() is vulnerable to external entities/DTDs and would allow us to execute malicious XXE payloads. The question from here is, how do we set ConfigFile class’s config\_raw variable.

From the **/includes/header.php** file, there are two interesting files that you cannot discover without the LFR vulnerability.

- /import\_memes\_2.0.php
- /export\_memes\_2.0.php

Each one sends a POST request to files of the same name in the /api/ directory.

**/api/import\_memes\_2.0.php**
...
The ConfigClass has a magic method function \_\_toString() that will get called any time the class is initialized and treated as a string. That usually means whenever the variable that has the class assigned to is echo, print, print\_r, etc.
...
We’ll talk about how that gets triggered after further explaining the attack. Following the \_\_toString() execution chain, we see that it immediately calls the parse() function.
...
This is promising because $this->config\_raw gets passed into the vulnerable loadXML() function call and does not get overwritten with anything static. That means if we create an object that gets unserialized, we can specify the config\_raw variable and it will execute our XXE payload.
...
- [https://gist.githubusercontent.com/ziot/e72c8c45865ea86d9c6aa6975615e839/raw/d0fb09a5a99be0c815c3e854e5b9900f2384b5dd/gistfile1.txt](https://gist.githubusercontent.com/ziot/e72c8c45865ea86d9c6aa6975615e839/raw/d0fb09a5a99be0c815c3e854e5b9900f2384b5dd/gistfile1.txt)

Using the script above, we ran base64\_encode(serialize()) functions on top of the newly created class after specifying our XXE payload inside of config\_raw.
...
The next step was uploading it using the import\_memes script:

- [https://h1-5411.h1ctf.com/import\_memes\_2.0.php](https://h1-5411.h1ctf.com/import_memes_2.0.php)

[![](http://buer.haus/wp-content/uploads/2018/10/7-300x130.png)](http://buer.haus/wp-content/uploads/2018/10/7.png)

No dice. We run into a warning saying we cannot array\_merge an array and an object. It makes sense, looking back on the code in /includes/config.php we can see that $\_SESSION\[“memes”\] is an array() and gets strings stored in it.
...
[![](http://buer.haus/wp-content/uploads/2018/10/8-300x140.png)](http://buer.haus/wp-content/uploads/2018/10/8.png)
...
Sending through a valid formed pickle to /update-status?status=&debug=1 resulted in the message:
...
- [https://gist.github.com/mgeeky/cbc7017986b2ec3e247aab0b01a9edcd](https://gist.github.com/mgeeky/cbc7017986b2ec3e247aab0b01a9edcd)
