...
source_url: https://portswigger.net/research/smashing-the-state-machine
title: "Smashing the state machine: the true potential of web race conditions | PortSwigger Research"
published: 2023-08-09T18:00:00
description: "For too long, web race condition attacks have focused on a tiny handful of scenarios. Their true potential has been masked thanks to tricky workflows, missing tooling, and simple network jitter hiding"
---
...
DEF CON 31 - Smashing the State Machine the True Potential of Web Race Conditions - James Kettle - YouTube

Tap to unmute

[DEF CON 31 - Smashing the State Machine the True Potential of Web Race Conditions - James Kettle](https://www.youtube.com/watch?v=tKJzsaB1ZvI) [DEFCONConference](https://www.youtube.com/channel/UC6Om9kAkl32dWlDSNlDS9Iw)
...
- [The true potential](https://portswigger.net/research/smashing-the-state-machine#introduction)

  - [Beyond limit-overrun](https://portswigger.net/research/smashing-the-state-machine#beyond-limit-overrun)
  - [Single-packet attack](https://portswigger.net/research/smashing-the-state-machine#single-packet-attack)
  - [Methodology](https://portswigger.net/research/smashing-the-state-machine#methodology)

- [Case studies](https://portswigger.net/research/smashing-the-state-machine#case-studies)

  - [Object masking](https://portswigger.net/research/smashing-the-state-machine#object-masking)
  - [Multi-endpoint](https://portswigger.net/research/smashing-the-state-machine#multi-endpoint)
  - [Single-endpoint](https://portswigger.net/research/smashing-the-state-machine#single-endpoint)
  - [Deferred](https://portswigger.net/research/smashing-the-state-machine#deferred)

- [Further research](https://portswigger.net/research/smashing-the-state-machine#further-research)
- [Defence](https://portswigger.net/research/smashing-the-state-machine#defence)
- [Takeaways](https://portswigger.net/research/smashing-the-state-machine#takeaways)
...
Discovering a race condition vulnerability in Gitlab with the single-packet attack - YouTube

Tap to unmute

[Discovering a race condition vulnerability in Gitlab with the single-packet attack](https://www.youtube.com/watch?v=Y0NVIVucQNE) [PortSwigger](https://www.youtube.com/channel/UCkytgKNbJ0L1UuN1K27GAKA)
...
Exploit: Simultaneous reset for $your-username and $victim-username``# Bypass 2FA
session['user'] = username
if 2fa_enabled:
    session['require2fa'] = true
Exploit: Simultaneous login and sensitive page fetch``# Session-swap
session['user'] = username
