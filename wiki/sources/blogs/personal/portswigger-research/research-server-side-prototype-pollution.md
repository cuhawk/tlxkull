...
source_url: https://portswigger.net/research/server-side-prototype-pollution
title: "Server-side prototype pollution: Black-box detection without the DoS | PortSwigger Research"
published: 2023-02-15T16:30:00
description: "Server-side prototype pollution is hard to detect black-box without causing a DoS. In this post, we introduce a range of safe detection techniques, which we've also implemented in an open source Burp"
---
...
Nullcon Berlin 2023 \| Server Side Prototype Pollution: Blackbox Detection Without The DoS by Gareth - YouTube

Tap to unmute

[Nullcon Berlin 2023 \| Server Side Prototype Pollution: Blackbox Detection Without The DoS by Gareth](https://www.youtube.com/watch?v=LD-KcuKM_0M) [nullcon](https://www.youtube.com/channel/UCI85JnsJEiKnkGiGBkqvZXw)

nullcon12.6K subscribers
...
- [Introduction](https://portswigger.net/research/server-side-prototype-pollution#introduction)
- [What is server-side prototype pollution?](https://portswigger.net/research/server-side-prototype-pollution#what-is-prototype-pollution)
- [Prototypal inheritance](https://portswigger.net/research/server-side-prototype-pollution#prototypal-inheritance)
- [JSON.parse()](https://portswigger.net/research/server-side-prototype-pollution#json-parse)
- [Vulnerable libraries](https://portswigger.net/research/server-side-prototype-pollution#vulnerable-libraries)
- [Impact of prototype pollution](https://portswigger.net/research/server-side-prototype-pollution#impact-of-prototype-pollution)
- [The DoS problem](https://portswigger.net/research/server-side-prototype-pollution#the-dos-problem)
- [Detection methods that cause DoS](https://portswigger.net/research/server-side-prototype-pollution#detection-methods-that-cause-dos)
- [Encoding](https://portswigger.net/research/server-side-prototype-pollution#encoding)
- [Constructor](https://portswigger.net/research/server-side-prototype-pollution#constructor)
- [Expect](https://portswigger.net/research/server-side-prototype-pollution#expect)
- [Request body overwrite](https://portswigger.net/research/server-side-prototype-pollution#request-body-overwrite)
- [Safe detection methods for manual testers](https://portswigger.net/research/server-side-prototype-pollution#safe-detection-methods-for-manual-testers)
- [Parameter limit](https://portswigger.net/research/server-side-prototype-pollution#parameter-limit)
- [Ignore query prefix](https://portswigger.net/research/server-side-prototype-pollution#ignore-query-prefix)
- [Allow dots](https://portswigger.net/research/server-side-prototype-pollution#allow-dots)
- [Content type](https://portswigger.net/research/server-side-prototype-pollution#content-type)
- [Safe automated detection methods](https://portswigger.net/research/server-side-prototype-pollution#safe-automated-detection-methods)
- [JSON spaces](https://portswigger.net/research/server-side-prototype-pollution#json-spaces)
- [Exposed headers](https://portswigger.net/research/server-side-prototype-pollution#exposed-headers)
- [Status](https://portswigger.net/research/server-side-prototype-pollution#status)
- [OPTIONS](https://portswigger.net/research/server-side-prototype-pollution#options)
- [JSON reflection](https://portswigger.net/research/server-side-prototype-pollution#json-reflection)
- [Immutable prototype](https://portswigger.net/research/server-side-prototype-pollution#immutable-prototype)
- [OAST](https://portswigger.net/research/server-side-prototype-pollution#oast)
- [Detecting JavaScript engines](https://portswigger.net/research/server-side-prototype-pollution#detecting-javascript-engines)
- [Debugging Node applications](https://portswigger.net/research/server-side-prototype-pollution#debugging-node-applications)
- [Preventing server-side prototype pollution](https://portswigger.net/research/server-side-prototype-pollution#preventing-server-side-prototype-pollution)
- [Use Map/Set](https://portswigger.net/research/server-side-prototype-pollution#use-map-set)
- [Deleting \_\_proto\_\_](https://portswigger.net/research/server-side-prototype-pollution#deleting-__proto__)
- [Null prototype](https://portswigger.net/research/server-side-prototype-pollution#null-prototype)
- [Credits](https://portswigger.net/research/server-side-prototype-pollution#credits)
- [Conclusion](https://portswigger.net/research/server-side-prototype-pollution#conclusion)
...
We'll start with a quick recap on what prototype pollution is and how it occurs. If you're already familiar with the basics you can skip to " [The DoS problem](https://portswigger.net/research/server-side-prototype-pollution#the-dos-problem)".
...
[**WebSocket Turbo Intruder: Unearthing the WebSocket Goldmine** 17 September 2025WebSocket Turbo Intruder: Unearthing the WebSocket Goldmine](https://portswigger.net/research/websocket-turbo-intruder-unearthing-the-websocket-goldmine) [**Exploiting prototype pollution in Node without the filesystem** 23 March 2023Exploiting prototype pollution in Node without the filesystem](https://portswigger.net/research/exploiting-prototype-pollution-in-node-without-the-filesystem)