...
source_url: https://portswigger.net/research/stealing-httponly-cookies-with-the-cookie-sandwich-technique
title: "Stealing HttpOnly cookies with the cookie sandwich technique | PortSwigger Research"
published: 2025-01-22T14:45:11
description: "In this post, I will introduce the 'cookie sandwich' technique which lets you bypass the HttpOnly flag on certain servers. This research follows on from Bypassing WAFs with the phantom $Version cookie"
---
...
the special
[$Version](https://github.com/apache/tomcat/blob/4111137da8712add015a4193da0f7d4d9248941e/java/org/apache/tomcat/util/http/parser/Cookie.java%23L147)
attribute.

- If cookie value starts with double quotes, it will continue reading
until the next unescaped double quotes char.
...
webpage content - perhaps through a [CORS](https://portswigger.net/web-security/cors) request with credentials or an XSS
...
[XSS](https://portswigger.net/web-security/cross-site-scripting) vulnerability on an error page. Here’s how I was able to use it to steal
...
[oncontentvisibilityautostatechange](https://x.com/garethheyes/status/1854191120277733760). Thanks to [@garethheyes](https://x.com/garethheyes) who helped
me with that trick:
...
[RFC2109](https://datatracker.ietf.org/doc/html/rfc2109) and
...
cookies have Path value /json to change cookie order.
