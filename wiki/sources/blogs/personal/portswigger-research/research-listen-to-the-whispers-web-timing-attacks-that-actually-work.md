...
source_url: https://portswigger.net/research/listen-to-the-whispers-web-timing-attacks-that-actually-work
title: "Listen to the whispers: web timing attacks that actually work | PortSwigger Research"
published: 2024-08-07T18:10:21
...
DEF CON 32 - Listen to the Whispers: Web Timing Attacks that Actually Work - James Kettle - YouTube

Tap to unmute

[DEF CON 32 - Listen to the Whispers: Web Timing Attacks that Actually Work - James Kettle](https://www.youtube.com/watch?v=zOPjz-sPyQM) [DEFCONConference](https://www.youtube.com/channel/UC6Om9kAkl32dWlDSNlDS9Iw)
...
Discovering a WAF bypass via timing analysis - YouTube

Tap to unmute

[Discovering a WAF bypass via timing analysis](https://www.youtube.com/watch?v=tZx_dmcOfqk) [PortSwigger](https://www.youtube.com/channel/UCkytgKNbJ0L1UuN1K27GAKA)

![thumbnail-image](https://yt3.ggpht.com/ytc/AIdro_m8KkyMC_9oZoyPQ6HW5k1FsWnEzE2X49khs769tRs-fg=s68-c-k-c0x00ffffff-no-rj)
...
| --- | --- | --- |
| key=a\\"bb | "error": {<br>  "message": "Invalid Key: a\\"bb"<br>} | 24.3ms |
| key=a"\\bb | "error": {<br>  "message": "Invalid Key: a"\\bb"<br>} | 24.1ms |
...
| Parameter | Response | Time |
| --- | --- | --- |
| key=aaa…a"bbb | "error": {<br>  "message": "Invalid Key: \*\*\*\*bbb"<br>} | 24.3ms |
