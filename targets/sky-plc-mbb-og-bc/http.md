# Sky UK/ROI Vulnerability Disclosure Program

> Platform: Bugcrowd — https://bugcrowd.com/engagements/sky-plc-mbb-og
> Type: BBP
> Bounty: P1 $500–$1000
> Status: In progress
...
- in: All internet facing Sky UK/ROI assets (GraphQL, Website Testing)

## Out-of-Scope Explicit Domains/Subsidiaries

- out: *skybroadband.com (subscriber-hosted)
- out: *skybet.com
- out: *skynewsarabia.com
- out: *skynews.com.au
- out: All internet facing Sky DACH assets (separate program)
- out: All internet facing Sky Italy assets (separate program)
...
**Validation:** ~3 days (very fast)  
**Average payout:** $750 (last 3 months)  
...
- Swagger-UI XSS (P5/informational, not eligible for bounty)
